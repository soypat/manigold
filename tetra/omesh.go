...
func NewOpti(nodes []r3.Vec, tetras [][4]int) *opti {
...
func (om *opti) foreach(f func(i int, on *onode)) {
...
func (om *opti) compressAndSmooth(compress float64, s interface{ Evaluate(r3.Vec) float64 }) {
